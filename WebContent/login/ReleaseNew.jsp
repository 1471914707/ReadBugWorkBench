...
<body>
<div class="Layer">
	<div class="Publish">发布新闻</div>
	<div class="ContentMain">
		<form action="${pageContext.request.contextPath}/login/HandleArticle" method="post" name="myform"><br>
		<input id="Title" type="text" size="78" name="title" placeholder="请在这里输入标题" class="form-control">
		<br  />
